                ...
                {step === 'form' ? (
                    <div className="p-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all outline-none text-sm"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-700 uppercase mb-1.5">Primary Goal</label>
                                    <select 
                                        value={goal}
                            ...
                            <button 
                                type="submit" 
                                disabled={loading}
                                className="w-full bg-brand-600 hover:bg-brand-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-brand-600/20 transform transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2"
                            >
                                {loading ? 'Processing...' : <>Secure Deal & Unlock <Zap className="w-4 h-4 fill-white" /></>}
                            </button>
                        </form>
                    </div>
                ) : (
                    <div className="p-8 text-center animate-in zoom-in-95 duration-300">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed text-sm">
                            ...
                            <br/>
                            Expect an email on <b>February 1st</b> containing your personal access link and the 50% discount code.
                        </p>
